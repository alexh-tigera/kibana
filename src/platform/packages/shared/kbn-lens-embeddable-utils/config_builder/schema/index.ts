...
export const _lensApiConfigSchema: any = objectUnion(
  ...
  { meta: { id: 'lensApiConfig', title: 'Visualizations', description: 'Visualization configuration. Use the `type` field to specify the chart type. Each chart type has its own set of required and optional fields.' } }
);
