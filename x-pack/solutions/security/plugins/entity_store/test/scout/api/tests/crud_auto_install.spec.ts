...
apiTest.describe(
  'Entity Store CRUD auto-install tests',
  ...
  () => {
    ...
    apiTest(
      'Should auto-install entity store on CRUD create',
      async ({ apiClient, esClient }) => {
        ...
        const create = await apiClient.post(
          ENTITY_STORE_ROUTES.public.CRUD_CREATE('generic'),
          {
            headers: defaultHeaders,
            responseType: 'json',
            body: entityObj,
    ...
    apiTest(
      'Should auto-install entity store on CRUD update',
      async ({ apiClient, esClient }) => {
        // Reset state
        ...
        const create = await apiClient.post(
          ENTITY_STORE_ROUTES.public.CRUD_CREATE('host'),
          {
            headers: defaultHeaders,
            responseType: 'json',
            body: createObj,
    ...
    apiTest(
      ...
      async ({ apiClient, esClient }) => {
        ...
        const bulkUpdate = await apiClient.put(
          ENTITY_STORE_ROUTES.public.CRUD_BULK_UPDATE,
          {
            headers: defaultHeaders,
            responseType: 'json',
            body: {
