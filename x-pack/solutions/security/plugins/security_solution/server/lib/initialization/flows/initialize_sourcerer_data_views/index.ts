...
import type {
  DataViewPayload,
  InitializeSourcecererDataViewsPayload,
  InitializeSourcecererDataViewsProvisionContext,
} from './types';
import {
...
export const initializeSourcecererDataViewsFlow: InitializationFlowDefinition<InitializeSourcecererDataViewsProvisionContext> =
  {
    id: 'sourcerer-data-views',

    resolveProvisionContext: async (
      context: InitializationFlowContext
    ): Promise<InitializeSourcecererDataViewsProvisionContext> => {
    ...
    provision: async (
      ...
      const payload: InitializeSourcecererDataViewsPayload = {
        alertDataView,
        defaultDataView,
        kibanaDataViews,
        signalIndexName,
      ...
      return { payload: payload as Record<string, unknown>, status: 'ready' };
    },
  };
